...
## V12: AI Program Managers And Rival Adaptation Loop

Numbering note: originally labeled V11; re-slotted to V12 on 2026-05-24 after
V11 shipped as Official USA Dodgeball Rules. Active spec:
`docs/specs/2026-05-24-v12-ai-program-managers/design.md`.
...
## V13: Broadcast And Presentation Layer

Numbering note: originally labeled V12; re-slotted to V13 on 2026-05-24 so V12
captures the re-slotted AI Program Managers loop. Active spec:
`docs/specs/2026-05-24-v13-broadcast-presentation/design.md`.
